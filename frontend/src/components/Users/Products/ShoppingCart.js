...
import { changeOrderQuantityAction, getCartItemFromLocalStorage,removeOrderItemAction } from "../../../redux/slices/cart/cartSlices";
import { fetchSingleCouponAction } from "../../../redux/slices/coupons/couponSlices";
import {
  CheckIcon,
  ClockIcon,
...
let sumTotalPrice = 0;
  ...
  //remove from cart
  const removeOrderItemFromCartHandler = (productId)=> {
                    ...
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      ...
                      <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <div className="absolute top-0 right-0">
                          <button
                            onClick={() =>
                              removeOrderItemFromCartHandler(
                                product?._id
                              )
                            }
